...
Desenvolvedor Full Stack com experiência em **Despachante Marcelino Ltda**, especializado em **React**, **Node.js** e **PostgreSQL**. Apaixonado por criar produtos escaláveis, sistemas orientados a dados e soluções que transformam ideias em impacto real nos negócios.
...
- Visão estratégica do produto, não apenas técnica
- Experiência com IA e integração de APIs avançadas
...
- 🧮 **Essential Math for AI** - Columbia University (ColumbiaX)
- 💾 **Programming & Data Structures** - Columbia University (ColumbiaX)
- 🔒 **GitHub Dependabot Security** - GitHub Learning
- 📋 **Agile Planning with GitHub Projects & Azure Boards** - Microsoft Learn
- 🏆 **Reconhecimento Nacional** em competições acadêmicas
...
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=ArthurDS-tech&show_icons=true&theme=dracula&include_all_commits=true&count_private=true"/>
...
Estou sempre aberto a discutir novos projetos, oportunidades de colaboração ou apenas trocar ideias sobre tecnologia e inovação!
